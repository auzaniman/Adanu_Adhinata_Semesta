...
@section('title') Cetak Pengajuan @endsection
        ...
        <div class="card-body">
          <div class="mt-3">
            <button class="btn btn-sm btn-success">
              ...
              <a href="" class="text-white">Cetak Pengajuan Akuisisi</a>
            </button>
            <button class="btn btn-sm btn-success">
              <i class="bi bi-printer-fill"></i>
              <a href="" class="text-white">Cetak Pengajuan LC</a>
            </button>
            <button class="btn btn-sm btn-success">
              <i class="bi bi-printer-fill"></i>
              <a href="" class="text-white">Cetak Pengajuan MP</a>
            </button>
          </div>
