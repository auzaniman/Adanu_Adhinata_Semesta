          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
              <button class="btn btn-sm btn-primary">
                ...
                <a href="{{ route('audit_iklan') }}" class="text-white">List Audit Baru</a>
              </button>
              <button class="btn btn-sm btn-primary">
                <i class="bi bi-bar-chart-fill"></i>
                <a href="" class="text-white">Statistik Iklan</a>
              </button>
            </div>
          </div>
                  ...
                  @forelse ($data as $item)
                    @if ($item->tim == 'Akuisisi')
                      <tr>
                        ...
                        <td>
                          <i class="bi bi-check-circle-fill me-1 text-success"></i>{{ $item->status }}
                        </td>
                        <td>
                          <button class="btn badge bg-info">
                            <i class="bi bi-pencil me-1 text-white"></i>
                            <a href="{{ route('show_dana_acc', $item->aia_id) }}" class="text-white">Edit</a>
                          </button>
                        </td>
                      </tr>
                    @else
